...
if student_gpa >= 3.5:
    if 50 <= student_score <= 65:
        ...
        print(f"Students with GPA {student_gpa} and test score of {student_score} may be eligible for a full scholarship")
    else:
        print(f"Students with GPA {student_gpa} and test score of {student_score} is not eligible for a scholarship")
else:
